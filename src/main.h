...
static const int LAST_POW_BLOCK = 43197;
...
static const uint256 hashGenesisBlock("0x000004ec9f77d6bc5064ea7c3b3786b4e09835bedc8ebecf00d98f9035ef8934");
static const uint256 hashGenesisBlockTestNet("0x000004ec9f77d6bc5064ea7c3b3786b4e09835bedc8ebecf00d98f9035ef8934");
...
public:
    ...
    {
        // doscoin: the coin stake transaction is marked with the first output empty
    ...
    */
    ...
    bool GetCoinAge(CTxDB& txdb, uint64_t& nCoinAge) const;  // doscoin: get transaction coin age
...
public:
    ...
    // doscoin: block signature - signed by one of the coin base txout[N]'s owner
    ...
    // doscoin: two types of block: proof-of-work or proof-of-stake
    ...
    // doscoin: get max transaction timestamp
    ...
    bool AcceptBlock();
    bool GetCoinAge(uint64_t& nCoinAge) const; // doscoin: calculate total coin age spent in block
...
public:
    ...
    unsigned int nFile;
    unsigned int nBlockPos;
    uint256 nChainTrust; // doscoin: trust score of block chain
    int nHeight;

    int64_t nMint;
    int64_t nMoneySupply;

    unsigned int nFlags;  // doscoin: block index flags
    enum  
    {
